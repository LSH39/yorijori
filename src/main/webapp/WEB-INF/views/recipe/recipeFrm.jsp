...
<body>
	<div class="main">
		...
		<form action="/recipeFrm.do" method="post"
			...
			<div class="recipeFrm">
				<label for="recipeTitle">레시피 제목 </label><input type="text"
					id="recipeTitle" name="recipeTitle"
					placeholder="예) 맛있는 소고기 미역국 끓이기 ">
			</div>
			<div class="recipeFrm">
				<label for="subhead">요리 한줄설명</label> <input type="text" id="subhead"
					name="subhead" placeholder="레시피를 소개할 수 있는 한줄 설명을 입력해주세요">
			</div>
			<div class="recipeFrm">
				<label for="uploadImg">대표이미지</label> <input type="file"
					id="uploadImg" name="uploadImg" onchange="loadImg(this);"
			...
			<div class="recipeFrm">
				<label for="recipeVideo">동영상 링크</label><input type="text"
					name="recipeVideo" placeholder="동영상이 있으면 온라인 링크만 걸어주세요(생략가능)">
			</div>
			<div class="recipeFrm">
				<p>음식정보</p>
				<div id="recipeFrm1">
					<label for="foodName">음식이름</label><input type="text" id="foodName"
						name="foodName" placeholder="음식명을 입력하세요"> <input
						type="text" id="recipeTime" name="recipeTime"
			...
			<div class="recipeFrm">
				...
				<select name="situation" id="situation">
					...
					<option value="혼밥/자취">혼밥/자취</option>
					<option value="간식">간식</option>
					<option value="유아식">유아식</option>
					<option value="비건/채식">비건/채식</option>
