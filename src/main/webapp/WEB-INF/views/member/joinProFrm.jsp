...
<body>
            ...
            <div class="content">
                ...
                <form method="POST" id="join_form">
                    <div class="center">
                        ...
                        <p class="title" id="file_txt">자격증 인증파일 <span>*</span><span class="join_check"></span></p>
                        <input type="text" id="filename" class="input_txt" placeholder="JPG, JPEG, PNG, GIF 파일만 등록 가능합니다" readonly>
                        <input type="file" id="certificatePath" name="file" onchange="fileChange(this);" accept=".jpg, .jpeg, .png, .gif">
                        <label for="certificatePath" class="gray_btn">파일첨부</label>
    ...
    <script>
        ...
        $("#submit_btn").click(function(){
        	if(checkId*checkPw*checkEmail*checkName*checkNickname*checkPhone*checkBirth*checkAddr*checkFile*checkBox!=1){
