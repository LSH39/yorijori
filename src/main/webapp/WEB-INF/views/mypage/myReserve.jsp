        ...
        <div class="main-content">
            ...
            <table border="1" class="classForm">
                <tr>
                    ...
                    <c:forEach items="${list}" var="mcl" varStatus="i">
                <tr>
                    <td>${mcl.rsrvNo }</td>
                    <td>${mcl.classTitle }</td>
                    <td>${mcl.classCurrNop }</td>
                    <td>${mcl.classStart }</td>
                    <td>${mcl.classEnd }</td>
                    <td>${mcl.classPrice }</td>
                    <td>${mcl.classTime }</td>
                    <td>${mcl.classLocation }</td>
                    <td>${mcl.classStatus }</td>
