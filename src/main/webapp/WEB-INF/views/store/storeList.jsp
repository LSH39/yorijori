		 ...
		 -->
			<div class="d-flex align-items-start">
				<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<button class="nav-link active" id="v-pills-seoul-tab" data-bs-toggle="pill" data-bs-target="#v-pills-seoul" type="button" role="tab" aria-controls="v-pills-seoul" aria-selected="true">서울</button>
    				<button class="nav-link" id="v-pills-kyeonggi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-kyeonggi" type="button" role="tab" aria-controls="v-pills-kyeonggi" aria-selected="false">경기</button>
    				<button class="nav-link" id="v-pills-incheon-tab" data-bs-toggle="pill" data-bs-target="#v-pills-incheon" type="button" role="tab" aria-controls="v-pills-incheon" aria-selected="false">인천</button>
	    			<button class="nav-link" id="v-pills-chungnam-tab" data-bs-toggle="pill" data-bs-target="#v-pills-chungnam" type="button" role="tab" aria-controls="v-pills-chungnam" aria-selected="false">충남</button>
	    			<button class="nav-link" id="v-pills-busan-tab" data-bs-toggle="pill" data-bs-target="#v-pills-busan" type="button" role="tab" aria-controls="v-pills-busan" aria-selected="false">부산</button>
  				</div>
